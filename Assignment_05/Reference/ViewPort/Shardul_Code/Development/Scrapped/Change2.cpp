...
GLint delay_counter = 0;
GLint delay_counter_animate = 0;
BOOL time_for_viewport_animation = 0;
...
void  disp_triangle(void)
{
	...
	{
		time_for_viewport_animation = 1;
	}
	else
	{
		time_for_viewport_animation = 0;
	}

	if (time_for_viewport_animation==1)
	{
		animateViewPort();
	}
}
